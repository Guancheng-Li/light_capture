...
_ICON_MAPPING = {
    ...
    'blur': 'blur',
    'blur_clicked': f'blur_{_CLICKED_COLOR}',
    'check': 'check',
    'circle': 'circle',
    'circle_clicked':  f'circle_{_CLICKED_COLOR}',
    'eraser': 'eraser',
    'eraser_clicked':  f'eraser_{_CLICKED_COLOR}',
    'close': 'close',
    'move': 'move',
    'move_clicked': f'move_{_CLICKED_COLOR}',
    'pen': 'markpen',
    'pen_clicked': f'markpen_{_CLICKED_COLOR}',
    'pencil': 'pencil',
    'pencil_clicked': f'pencil_{_CLICKED_COLOR}',
    'rectangle': 'rectangle',
